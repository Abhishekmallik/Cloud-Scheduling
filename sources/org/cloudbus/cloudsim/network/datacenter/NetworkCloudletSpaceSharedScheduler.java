...
//						NetDatacenterBroker.totalExeCost += cl.timespentInStage * NetDatacenterBroker.executionCost[cl.getVmId()] ;
						NetDatacenterBroker.totalExeCost += st.time * NetDatacenterBroker.executionCost[cl.getVmId()] ;
						NetDatacenterBroker.totalExeCostArr[cl.getVmId()] += st.time * NetDatacenterBroker.executionCost[cl.getVmId()] ;
